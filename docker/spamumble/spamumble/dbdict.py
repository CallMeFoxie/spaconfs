''' from http://code.activestate.com/recipes/576642-dbm-with-dict-speed-accesses-and-multiple-standard/
...
class DictDB(dict):
    ...
    def dump(self, file):
        if self.format == 'csv':
            ...
            json.dump(self, file, separators=(',', ':'), sort_keys=True, indent=4)
